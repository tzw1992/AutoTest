...
public class MyGetMethod {
     ...
     * 模拟一个获取商品列表
     */
    @RequestMapping(value = "get/with/parm",method = RequestMethod.GET)
    @ApiOperation(value = "需要携带参数才能访问的请求方法",httpMethod = "GET")
    ...
    @ApiOperation(value = "需要携带参数才能访问的第二种实现",httpMethod = "GET")
